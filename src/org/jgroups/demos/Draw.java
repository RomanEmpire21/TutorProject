...
public class Draw extends ReceiverAdapter implements ActionListener,
    ...
    private JButton clear_button, leave_button, browse_button;
    ...
    // This does the drawing on the canvas...
    ...
    public void go() throws Exception {
        ...
        // This is where the background should get set...
        mainFrame.setBackground(Color.blue);
        //        
        clear_button.setForeground(Color.blue);
        leave_button.setForeground(Color.blue);
        browse_button.setForeground(Color.blue);
        
        mainFrame.pack();
        mainFrame.setLocation(15, 25);
        mainFrame.setBounds(new Rectangle(450, 450));
